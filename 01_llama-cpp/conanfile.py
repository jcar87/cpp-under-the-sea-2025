...
class LlamaCppConan(ConanFile):
    ...
    def requirements(self):
        ...
        if self.options.with_cuda:
            self.requires("cuda-toolkit/[>=12.0]")
    ...
    def generate(self):
        ...
        tc.cache_variables["LLAMA_CURL"] = self.options.get_safe("with_curl")
        tc.cache_variables["CMAKE_CUDA_ARCHITECTURES"] = "75-real"
        ...
        tc.cache_variables["GGML_CUDA"] = self.options.get_safe("with_cuda")
    ...
    def package_info(self):
        ...
        for backend in backends:
            ...
            if backend == "cuda":
                self.cpp_info.components[f"ggml-cuda"].requires.append("cuda-toolkit::cuda-toolkit")
